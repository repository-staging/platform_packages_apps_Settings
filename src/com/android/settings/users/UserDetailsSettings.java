...
public class UserDetailsSettings extends SettingsPreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPhonePref) {
            ...
            mUserRestrictionsFetcher.set(UserManager.DISALLOW_RUN_IN_BACKGROUND, !((boolean) newValue));
            return true;
        }
    ...
    void initialize(Context context, Bundle arguments) {
        ...
        mUserRestrictionsFetcher = UserRestrictionsFetcher.create(mUserManager, mUserInfo);
        ...
        if (!mUserManager.isAdminUser()) { // not allow calls for non admin users.
            ...
            if (mUserInfo.isGuest()) {
                ...
                mRunInBackgroundPref.setChecked(!mUserRestrictionsFetcher.isSet(
