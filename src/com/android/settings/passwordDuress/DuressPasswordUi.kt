...
class DuressPasswordUi : AppCompatActivity() {
    ...
    private val editorActionListener = TextView.OnEditorActionListener { view, actionId, _ ->
        ...
        //if the user is typing hide the error msg and return
    ...
    private fun validatePin(pin: String) = validatePinOrPassword(
            pinOrPassword = pin,
            isPin = true
    )

    private fun validatePassword(password: String) = validatePinOrPassword(
